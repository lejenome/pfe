...
\begin{figure}[htbp]
    ...
    \centering
  \centering
  \includegraphics[width=0.9\linewidth]{sprint3-dashboard-screenshot1}
...
\begin{subfigure}{.5\textwidth}
    \centering
  \centering
  \includegraphics[width=0.9\linewidth]{sprint3-dashboard-screenshot2}
...
\centering
    ...
    \centering
  \centering
  \includegraphics[width=.9\linewidth]{sprint3-android-screenshot1}
...
\begin{subfigure}{.3\textwidth}
    \centering
  \centering
  \includegraphics[width=.9\linewidth]{sprint3-android-screenshot2}
  \caption{État activé}
