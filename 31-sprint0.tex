...
\begin{description}
    ...
    \item [Implémentation] La pourcentage de l'implémentation du tâche de 0\%
        ...
        minutes nommé \textquote{Daily Scrum} pendant le, on discute
...
La version du SDK choisie est 23 qui vise la version Android 6.0.
ayant un taux d'utilisateur qui est 40\% en Main 2017~\cite{android-sdk}.
