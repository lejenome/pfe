...
Dans cette partie, nous allons présenter l'académie ``Djagora Academy'' au sein
duquel nous avons effectué notre stage de fin d'études et le projet
``CityWatch'' que nous sommes en train de réaliser avec la communauté de
l'académie. Nous allons présenter l'objective du projet et la méthodologie de
...
en année terminale dans la réalisation de projets d'intéret publique dans le but
est la création des start-ups.

Pendant la réalisation des projets des idées des start-ups, les étudiants
...
\subsubsection{Le responsable produit}
...
\begin{itemize}
 \item \textbf{Personnel engagé :} l’une des caractéristiques de SCRUM, 
 ...
 \item \textbf{ Meilleur vue d’ensemble du projet :} avec SCRUM, les projets 
 ...
 \item \textbf{Réduction des bugs :}la méthode SCRUM privilégie la qualité et la
 fonctionnalité des développements. Le nombre de bugs et
 de reprises est ainsi réduit.
 \item \textbf{Mise à jour des priorités :}au début, le client ignore toute 
 ...
 \item \textbf{Qualité du produit mise en avant :}la méthode SCRUM se concentre davantage 
