...
Le projet présent est effectué au sein de \textquote{Djagora Academy} avec un équipe des étudiants. Dans la partie qui suit, on va présenter l'organisme
...
collectivement avec les autres membres, nos tâches visent la
...
elles seront analysées et visualisées en forme des diagrammes et des cartographiques.
Finalement, elles seront utilisées pour assister l'utilisateur dans la route.
Ses différentes couches sont présentées dans la figure~\ref{fig:citywatch-modules}.
