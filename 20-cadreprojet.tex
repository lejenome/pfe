...
\section{Application similaires}

Nous avons essayé d'étudier les applications similaires existantes dans le marché.
Parmi les meilleurs applications les plus utilisé que nous avons trouvées sont Waze,
Here WeGo .

https://www.waze.com/
Waze est une application de trafic et de navigation géographique.
Il a été fondé en 2006 par Ehud Shabatai et racheté par Google en février 2014.

Here WeGo est un logiciel de cartographie gratuit développé par HERE Global B.V.,
accessible à partir d’un ordinateur, un téléphone ou d’une tablette.
Il a été fondé en 2014 par Nokia.
