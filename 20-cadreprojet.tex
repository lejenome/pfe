...
projet, nommées \textquote{Project Diamond}:

\begin{description}
    \item [Fonctionnalités] Les cas d'utilisations demandés par le Product
        Owner.
    \item [Resources] Budget fourni par le Product Owner.
