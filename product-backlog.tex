...
\begin{tikzpicture}[every annotation/.style={draw, fill=white, font=\Large}]
    ...
    child[concept color=blue!70] {
        node {Gestions des Rapports} [clockwise from=50]
        child { node { Consultation } }
        child { node { Déclaration } }
    }
    child[concept color=green!40!black] {
        node[concept] {Information Routière} [clockwise from=30]
        child { node[concept] {Secousses} }
        child { node[concept] {Ralentisseurs}}
        child { node[concept] {Emboutiage}}
    }
    child[concept color=blue] {
        node[concept] {Itinéraire} [clockwise from=305]
        child { node[concept] {Localisation instantanée} }
        child { node[concept] {Projection du Trajectoire} }
        child { node[concept] {Historie des Trajectoires} }
    }
    ...
    child[concept color=orange] {
        node[concept] {Tableau de Bord} [counterclockwise from=100]
        child { node[concept] {Carte en Temps Réel}}
        child { node[concept] { Authentification } }
        child { node[concept] {Filtrages} }
    }
    child[concept color=yellow!60!black] {
        node[concept] (Blogs) {Analyse et Visualization} [clockwise from=135]
        child { node[concept] {Visualisation des données}}
        child { node[concept] {Tableau du board intéractive}}
    }
