...
plateforme \textquote{City Watch}, nous avons suivi différentes formations sur
...
\begin{description}
    \item [Git] Logiciel de gestion de versions distribué avec des branches
        ...
        chaque développeur à un clone complet du dépôt. Le modèle Fork
    ...
    \item [Apache SVN] Logiciel de gestion de versions centralisé. Il est connu
        ...
        vs.  Dépôt distant, on faire juste une copie du dossier de travail dans
        une version précise. Les commandes sont simples:
        \begin{itemize}
            \item \verb|svn checkint| vs. \verb|git commit; git push|
...
des exigences de spécification. \FIXME{improve sentance}
...
choisi est la même représentation des nombres en JSON avec une précision
jusqu'à 14 chiffres après le virgule. Les valeurs envoyés doivent respecte
l'intervalle des diffèrent entités géologiques ($latitude \in [-90, 90]$,
