...
Les deux logiciels de gestion de versions les plus répondus sont Git et SVN.

\begin{description}
    \item [Git] \TODO{pros du git}
    \item [SVN] \TODO{pros du SVN}
\end{description}

\TODO{conclusion et pourquoi choisi SVN}
