...
\usepackage[shorthands=off,french,english]{babel}
...
\title{CityWatch - Final Project Report}
\author{Moez Bouhlel}
\author{Rihab Majdoub}
\affil{Faculty of Sciences of Sfax, Tunisia}
...
\addcontentsline{toc}{chapter}{List of Accronymtype}
\printglossaries
