...
%\logo{\includegraphics[width=4cm]{../figures/logo-djagora.png}}
%\logo{\includegraphics[width=2cm]{../figures/fss-old.eps}}
\titlegraphic{\includegraphics[width=2cm]{../figures/fss-old.eps}}
\date{05/06/2017}
\begin{document}
{
    \makeatletter
