...
L'objectif de cette itération vise trois environnements.Nous allons ajouter une nouvelle
vision par rapport à l'itération précédentes.
...
\begin{itemize}
 \item \textbf{Smart phone :} L'ajout de nouvelles fonctionnalités comme :
	...
	\end{itemize}
\item \textbf{Dashboard :} Enrichir la carte par :
	\begin{itemize}
	 \item Des nouveaux marqueurs qui spécifient chaque type de rapport ajouté.
	 \item Une légende pour le filtrage des marqueurs. 
	\end{itemize}
\item \textbf{Rapport :} La création d'une page rapport qui permet à l'utilisateur de:
	\begin{itemize}
