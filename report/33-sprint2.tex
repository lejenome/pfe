...
réaliser au cours de cette itération en accord avec le \textquote{Product
Owner}.
...
Comme l'itération précédente, nous avons fixé la période de cette itération à 3
...
\subsection{Qualité de la trajectoire}
...
orientée objet de la page \textquote{Dashboard}.
