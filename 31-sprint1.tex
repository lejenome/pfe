...
\begin{itemize}
    ...
    \item Code Revue à la fin d'itération fait par tous les membres pour
        ...
        d'implementation.
\end{itemize}
\textbf{NB:} les deux colonnes colorés qui présente dans la figure~\ref{fig:sprint1-fig1},~\ref{fig:sprint1-fig2}
et~\ref{fig:sprint1-fig2} notre travail du binôme.
\begin{figure}[htbp]
    \centering
